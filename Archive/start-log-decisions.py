...
projectID = (formData['project_id'].value).split(',')
parameterName = (formData['parameter_name'].value).split(',')
parameterUnit = (formData['parameter_unit'].value).split(',')
parameterLowerBound = (formData['parameter_lower_bound'].value).split(',')
parameterUpperBound = (formData['parameter_upper_bound'].value).split(',')
...
# c.execute(query, (projectID[0], parameterName, parameterUnit, parameterLowerBound, parameterUpperBound))
    conn.commit()
conn.close()
